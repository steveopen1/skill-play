...
通过 `@` 语法引用 `data/` 目录下的 Payload 文件。

## SQL 注入 (data/web/sqli/)

```
@data/web/sqli/mysql.md        # MySQL
@data/web/sqli/mssql.md        # MSSQL
@data/web/sqli/oracle.md       # Oracle
@data/web/sqli/postgresql.md    # PostgreSQL
@data/web/sqli/mongodb.md       # MongoDB
@data/web/sqli/redis.md         # Redis
@data/web/sqli/blind.md        # 盲注
...
```
@data/web/xss/xss-detail.md     # XSS 详细
...
@data/web/websocket.md          # WebSocket
...
```
1. @data/web/sqli/mysql.md 获取 MySQL Payload
2. @data/web/sqli/waf-bypass.md 获取绕过方法
3. @data/web/sqli/attack-chain.md 构造攻击链
```
